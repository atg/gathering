...
def addRow(kind, module, parent, name, fobj, obj, isDocumented):
    ...
    addRowRaw(db, module, parent, name, original_namespace, kind, defline, docs, linedecl, superclass=superclass, fullsource=fullsource, isDocumented=isDocumented)
...
def parsePythonModule(mm, prefix):
    ...
    try:        
        ...
        for v in mmks:
            ...
            mp = prefix + '.' if prefix != '___builtins' else ''
            ismatchable = True
